...
PRODUCT_DEFAULT_PROPERTY_OVERRIDES += ro.secure=0 ro.debuggable=1 persist.sys.usb.config=mass_storage persist.service.adb.enable=1 rild.libpath=/system/lib/liballwinner-ril.so
